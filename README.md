...
## IN Brower
```html
<script src="https://unpkg.com/cirnostream@1.0.4/build/cirnostream.min.js"></script>
<script>
...
```
## Advance
You can also use an object as options to add new Event, [[see Event options structure]](#push-options)
```javascript
stream.push({
    name: 'AwsomeEvent',
...
| push | [click to description](#push-parameters) | Add an Event to the Stream, handler in that will be executed according to delay |
...
| type      | String   | Type of Event, contains "execute", "created", "closed", "forced" and "get", [see where those type from](#type-from) |
...
forced:  from method "on" of Stream, it will execute handler of specific Event Compulsorily
